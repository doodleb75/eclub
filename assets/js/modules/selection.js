        ...
        deleteButtons.forEach(btn => {
            btn.addEventListener('click', (e) => {
                ...
                if (checkedItems.length === 0) {
                    ...
                    if (window.Modal) {
                        window.Modal.open('/eclub/common/components/modal/modal-alert.html', {
                            width: modalWidth
                        });
                    }
                }
    ...
    initOrderHistory(container, master) {
        ...
        if (addCartBtn) {
            addCartBtn.addEventListener('click', () => {
                ...
                if (checkedCount === 0) {
                    if (window.Modal) {
                        window.Modal.open('/eclub/common/components/modal/modal-alert.html', { width: '400px' });
                    }
                } else {
                    if (window.Modal) {
                        // 기존 장바구니 담기 확인 모달 호출
                        window.Modal.open('/eclub/common/components/modal/modal-cart-confirm.html', { width: '400px' });
                    }
                }
            });
        }
